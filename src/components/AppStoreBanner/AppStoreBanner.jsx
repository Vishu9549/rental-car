...
console.log(AppStoreImg, PlayStoreImg, pattern); // Debugging

const bannerImg = {
  backgroundImage: `url(${pattern || "https://via.placeholder.com/500"})`,
        ...
        <div>
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            >
              <a href="#">
                <img
                  src={PlayStoreImg || "https://via.placeholder.com/150"}
                  alt="Play Store"
              ...
              <a href="#">
                <img
                  src={AppStoreImg || "https://via.placeholder.com/150"}
                  alt="App Store"
                  className="max-w-[150px] sm:max-w-[120px] md:max-w-[200px]"
                />
              </a>
